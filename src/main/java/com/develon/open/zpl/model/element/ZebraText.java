...
public class ZebraText extends ZebraElement {
	...
	public ZebraText(int positionX, int positionY, String text, int fontSize, ZebraRotation zebraRotation) {
		this.fontSize = fontSize;
		this.zebraRotation = zebraRotation;
		this.text = text;
		this.positionX = positionX;
	...
	/* (non-Javadoc)
	 * @see fr.w3blog.zpl.model.element.ZebraElement#getZplCode(PrinterOptions)
	 */
	@Override
